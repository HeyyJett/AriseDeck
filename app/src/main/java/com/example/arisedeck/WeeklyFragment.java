            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful() && !task.getResult().isEmpty()){
                    for (DocumentSnapshot document : task.getResult()) {
                        ...
                        String description1 = document.getString("WChal1Desc");
                        chal[0].setText(description1);

                        String description2 = document.getString("WChal2Desc");
                        chal[1].setText(description2);

                        String description3 = document.getString("WChal3Desc");
                        chal[2].setText(description3);

                        String description4 = document.getString("WChal4Desc");
                        chal[3].setText(description4);

                        String description5 = document.getString("WChal5Desc");
                        chal[4].setText(description5);

                        Boolean alreadyDone1 = document.getBoolean("WChal1");
                        ...
                        Boolean alreadyDone2 = document.getBoolean("WChal2");
                        ...
                        Boolean alreadyDone3 = document.getBoolean("WChal3");
                        ...
                        Boolean alreadyDone4 = document.getBoolean("WChal4");
                        ...
                        Boolean alreadyDone5 = document.getBoolean("WChal5");
