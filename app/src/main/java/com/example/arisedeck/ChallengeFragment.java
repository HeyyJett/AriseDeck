...
public class ChallengeFragment extends Fragment {
    ...
    // Don't need to save instance state, getting everything from the database
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful() && !task.getResult().isEmpty()){
                    for (DocumentSnapshot document : task.getResult()) {
                        ...
                        String description1 = document.getString("DChal1Desc");
                        chal[0].setText(description1);

                        String description2 = document.getString("DChal2Desc");
                        chal[1].setText(description2);

                        String description3 = document.getString("DChal3Desc");
                        chal[2].setText(description3);

                        String description4 = document.getString("DChal4Desc");
                        chal[3].setText(description4);

                        String description5 = document.getString("DChal5Desc");
                        chal[4].setText(description5);

                        Boolean alreadyDone1 = document.getBoolean("DChal1");
                        ...
                        Boolean alreadyDone2 = document.getBoolean("DChal2");
                        ...
                        Boolean alreadyDone3 = document.getBoolean("DChal3");
                        ...
                        Boolean alreadyDone4 = document.getBoolean("DChal4");
                        ...
                        Boolean alreadyDone5 = document.getBoolean("DChal5");
